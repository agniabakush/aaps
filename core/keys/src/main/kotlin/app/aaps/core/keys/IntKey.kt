...
enum class IntKey(
    ...
    ApsMaxMinutesOfBasalToLimitSmb("smbmaxminutes", 15, 15, 420, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
    ApsUamMaxMinutesOfBasalToLimitSmb("uamsmbmaxminutes", 15, 15, 420, defaultedBySM = true, dependency = BooleanKey.ApsUseSmb),
